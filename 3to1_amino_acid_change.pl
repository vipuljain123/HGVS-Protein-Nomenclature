# This script is created by Vipul Todarwal to convert 3 letter amino acid chnage to 1 letter amino acid change.
...
#	Usage 		=>	$ perl 3to1_amino_acid_change.pl <INPUT_FILE> <OUTPUT_FILE>
